            ...
            SOLID.map((solid)=>(
              <tr key ={solid.name}>
                ...
                <td>
                  ...
                  <h3>Pole: <span>{calc.calc(solid.type,"surfaceArea",...solid.exampleDimensions)?.toFixed(0)} j²</span></h3>
                  <h3>Objętość: <span>{calc.calc(solid.type,"volume",...solid.exampleDimensions)?.toFixed(0)} j³</span></h3>
                </td>
              </tr>
            ))
          }
